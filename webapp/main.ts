import { searchStopPlaces, getDepartures, type StopPlace, type EstimatedCall } from '@lib/entur-api';
...
searchInput.addEventListener('input', () => {
  ...
  debounceTimer = setTimeout(() => handleSearch(searchInput.value.trim()), 300);
});
...
function formatDeparture(call: EstimatedCall): { icon: string; line: string; dest: string; time: string; realtime: boolean } {
